...
### 6. 트러블 슈팅
  ...
  ★ 오치헌 :  </br>
  ★ 문형기 : 게임 선택 페이지 중간 즈음에 미리 저장한 문자열을 받아 역동적으로 움직이게 구현한 부분이 있는데, </br> 이 부분을 끊임 없이 움직이게 하고 싶었음. 
              ...
              계속 유지할 수 있도록 구현함. </br>
  ★ 도은빈 : missing script start : package.json의 파일이 잘못된 위치에 있었고, node_modules, package_lock.json 과 같은 위치로 </br> 변경 후
